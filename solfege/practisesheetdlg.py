...
class PractiseSheetDialog(Gtk.Window, gu.EditorDialogBase, lessonfilegui.ExercisesMenuAddIn):
    ...
    def __init__(self, filename=None):
        ...
        hbox.pack_start(Gtk.Label(label=_("Output format:")),
                        False, False, 0)
        ...
        hbox.set_spacing(6)
        vbox.pack_start(hbox, False, False, 0)
        hbox.pack_start(Gtk.Label(label=_("Title:")), False, False, 0)
        ...
        self.g_lbox = Gtk.Box(orientation=Gtk.Orientation.VERTICAL)
        ...
        #
        self.g_line_len = Gtk.SpinButton(adjustment=Gtk.Adjustment(
            value=0, lower=1, upper=10, step_increment=1,
            page_increment=10))
        ...
        #
        self.g_count = Gtk.SpinButton(adjustment=Gtk.Adjustment(
            value=0, lower=1, upper=1000, step_increment=1,
            page_increment=10))
    ...
    def setup_toolbar(self):
        self.g_toolbar = self.create_editor_toolbar([
            ...
            ('Create', _("_Create Sheet"), 'document-export-symbolic',
             self.on_create_sheet, None),
            ('Randomize', _("_Randomize"), 'media-playlist-shuffle-symbolic',
             self.on_randomize, None),
            'Close', 'Help'])
        self.vbox.pack_start(self.g_toolbar, False, False, 0)
